...
token_stream tstream_ptr;
{
    ...
    while(!token_found)
    {
        ...
        switch(next_st) 
        { 
            default : fprintf(file_name,"P26,"); break;
            case 6  : /* These are all KEYWORD cases. */
            case 9  :
            case 11 :
            case 13 :
		    case 12 : fprintf(file_name,"P111,");
            case 16 : fprintf(file_name,"P27,"); 
			        ch=get_char(tstream_ptr->ch_stream);
...
int state;
{
    ...
    {   /* Return the respective macro for the Keyword. */
        case 6 : fprintf(file_name,"P45,"); return(LAMBDA);
        case 9 : fprintf(file_name,"P46,"); return(AND);
        case 11: fprintf(file_name,"P47,"); return(OR);
        case 13: fprintf(file_name,"P48,"); return(IF);
        case 16: fprintf(file_name,"P49,"); return(XOR);
        default: fprintf(file_name,"P50,"); fprintf(stdout, "error\n");break;
    }
...
int state;
{
    ...
    {   /* return the respective macro for the special character. */
        case 19: fprintf(file_name,"P52,"); return(LPAREN);
        case 20: fprintf(file_name,"P53,"); return(RPAREN);
        case 21: fprintf(file_name,"P54,"); return(LSQUARE);
        case 22: fprintf(file_name,"P55,"); return(RSQUARE);
        case 23: fprintf(file_name,"P56,"); return(QUOTE);
        case 24: fprintf(file_name,"P57,"); return(BQUOTE);
        case 25: fprintf(file_name,"P58,"); return(COMMA);
        case 32: fprintf(file_name,"P59,"); return(EQUALGREATER);
        default: fprintf(file_name,"P60,");fprintf(stdout, "error\n");break;
    }
...
char token_str[];
{
    ...
    {   /* Return the respective CONSTANT macro. */
        case 27 : fprintf(file_name,"P65,"); return(STRING_CONSTANT);
        case 29 : fprintf(file_name,"P66,"); token_str[token_ind-2]=' '; return(CHARACTER_CONSTANT);
        default : fprintf(file_name,"P67,"); break;
    }
}
...
token token_ptr;
{
     ...
     {    /* Print the respective tokens. */
          case ERROR : fprintf(file_name,"P74,"); fprintf(stdout, "error,\t\"");fprintf(stdout, "%s",token_ptr->token_string);
                       fprintf(stdout, "\".\n");return(TRUE);
          case EOTSTREAM : fprintf(file_name,"P75,"); fprintf(stdout, "eof.\n");return(TRUE);
          case 6 : fprintf(file_name,"P76,"); fprintf(stdout, "keyword,\t\"lambda\".\n");return(TRUE);
          case 9 : fprintf(file_name,"P77,"); fprintf(stdout, "keyword,\t\"and\".\n");return(TRUE);
          case 11: fprintf(file_name,"P78,"); fprintf(stdout, "keyword,\t\"or\".\n");return(TRUE);
          case 13: fprintf(file_name,"P79,"); fprintf(stdout, "keyword,\t\"if\".\n");return(TRUE);
          case 16: fprintf(file_name,"P80,"); fprintf(stdout, "keyword,\t\"xor\".\n");return(TRUE);
          case 17: fprintf(file_name,"P81,"); fprintf(stdout, "identifier,\t\"");fprintf(stdout, "%s",token_ptr->token_string);
                   fprintf(stdout, "\".\n");return(TRUE);
          case 18: fprintf(file_name,"P82,"); fprintf(stdout, "numeric,\t");fprintf(stdout, "%s",token_ptr->token_string);
                   fprintf(stdout, ".\n");return(TRUE);
          case 19: fprintf(file_name,"P83,"); fprintf(stdout, "lparen.\n");return(TRUE);
          case 20: fprintf(file_name,"P84,"); fprintf(stdout, "rparen.\n");return(TRUE);
          case 21: fprintf(file_name,"P85,"); fprintf(stdout, "lsquare.\n");return(TRUE);
          case 22: fprintf(file_name,"P86,"); fprintf(stdout, "rsquare.\n");return(TRUE);
          case 23: fprintf(file_name,"P87,"); fprintf(stdout, "quote.\n");return(TRUE);
          case 24: fprintf(file_name,"P88,"); fprintf(stdout, "bquote.\n");return(TRUE);
          case 25: fprintf(file_name,"P89,"); fprintf(stdout, "comma.\n");return(TRUE);
          case 27: fprintf(file_name,"P90,"); fprintf(stdout, "string,\t");fprintf(stdout, "%s",token_ptr->token_string);
                   fprintf(stdout, ".\n");return(TRUE);
          case 29: fprintf(file_name,"P91,"); fprintf(stdout, "character,\t\"");fprintf(stdout, "%s",token_ptr->token_string);
                   fprintf(stdout, "\".\n");return(TRUE);
          case 32: fprintf(file_name,"P92,"); fprintf(stdout, "keyword,\t\"=>\".\n");return(TRUE);
          default: fprintf(file_name,"P93,");break;
      }
